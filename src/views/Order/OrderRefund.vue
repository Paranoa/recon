    ...
    <template slot="body">
      <div class="content-body">
        <div class="flex heightCenter">
          <span style="font-size:16px;margin-right:15px;">预约退货打款日期</span>
          ...
          <div class="flex" style="margin-left:20px;width:230px;">
            <div style="display: flex;align-items: center;justify-content: center;font-weight: bold;color: #fff;height: 14px;width: 14px;border-radius: 100%;background: #FF4545; margin-top:10px;margin-right:10px;">
              ！
            </div>
            <p style="margin-top:5px;">请在预约日期<span style="color:#5FCAFF;">16:00</span>之前完成打款，否则需要重新预约，可能会产生费用。</p>
          </div>
        </div>
        <div class="flex" style="margin-top:15px;" v-show="refundShow">
          <div class="left">
            <div class="flex">
              <strong style="width:120px;">贷款本金</strong>
              <p style="width:110px;"><strong>￥</strong>{{ loanAmt | fix2 }}</p>
              <i class="icon-question-sign" title="客户申请的借款金额"></i>
            </div>
            <div class="flex">
              <strong style="width:120px;" v-if="!hidePrincipal">已还本金</strong>
              <p style="width:110px;"><strong>￥</strong>{{ paidAmt | fix2 }}</p>
              <i class="icon-question-sign" title="客户已归还的贷款本金部分"></i>
            </div>
            <div class="flex">
              <strong style="width:120px;">剩余本金</strong>
              <p style="width:110px;"><strong>￥</strong>{{ corpus | fix2 }}</p>
              <i class="icon-question-sign" title="贷款本金-已还本金"></i>
            </div>
            <div class="flex">
              <strong style="width:120px;">+应还手续费</strong>
              <p style="width:110px;"><strong>￥</strong>{{ fee | fix2 }}</p>
            ...
            <div class="flex" v-show="showLateFee">
              ...
              <p style="width:110px;"><strong>￥</strong>{{ lateFee | fix2 }}</p>
              <i class="icon-question-sign" title="逾期应还金额5%（每个账单日计算一次并累加）"></i>
            </div>
            <div class="flex">
              <strong style="width:120px;" v-show="penaltiesShow">+罚息</strong>
              <p style="width:110px;"><strong>￥</strong>{{ penalties | fix2 }}</p>
              <i class="icon-question-sign" title="贷款本金*0.5‰逾期天数"></i>
            </div>
            <div class="flex">
              <strong style="width:120px;" v-show="otherFeeShow">+其他费用</strong>
              <p style="width:110px;"><strong>￥</strong>{{ otherFee | fix2 }}</p>
            </div>
            <div class="flex">
              <strong style="width:120px;">-贴息金额</strong>
              <p style="width:110px;"><strong>￥</strong>{{ merchantRefundFee | fix2 }}</p>
              <i class="icon-question-sign" title="商户贴息金额"></i>
            </div>
            <div class="flex">
              <strong style="width:120px;">合计</strong>
              <p style="width:110px;"><strong>￥</strong>{{ heji | fix2 }}</p>
            </div>
          </div>
          <div class="right">
            <div>
            ...
            <div class="flex">
              <strong style="width:75px;">金额</strong>
              <p><strong>￥</strong>{{ heji }}</p>
            </div>
            <div class="flex">
              <strong style="width:75px;">户名</strong>
              <p>即科金融信息服务（上海）有限公司</p>
            </div>
            <div class="flex">
              <strong style="width:75px;">开户行</strong>
              <p>中国银行上海市国定路支行</p>
            </div>
            <div class="flex">
              <strong style="width:75px;">账号</strong>
              <p>62178376292872788</p>
            </div>
            <div>
              <span style="color:#FF4545;font-size:20px;vertical-align: middle;">*</span>
